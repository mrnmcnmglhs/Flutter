                ...
                children: [
                  ...
                  Row(
                    children: [
                        ...
                        child: Column(
                          children: [
                            ...
                            Cardskill(
                              ...
                              icon2: Iconskill(img: 'images/figma.jpg'),
                              icon3: Iconskill(img: 'images/figma.jpg'),
                              icon4: Iconskill(img: 'images/figma.jpg'),
                            ),
                            Cardskill(
                              procentagem: "50%",
                              icon: Iconskill(img: 'images/figma.jpg'),
                      ...
                      Botao(nome: "Projetos", cor: Color(0XFFF3AF30), texto_cor: Colors.black, onPressed: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => TelaProjetos()));
                      }),

                      Botao(nome: "GitHub", cor: Color(0XFFBE2A52), texto_cor: Colors.white, onPressed: () async)
                    ],
                  ),
                ],
              ),
